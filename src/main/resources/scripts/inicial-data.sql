...
insert into products (name, image, unit_price, description, size, concentration, category_id) values('Absolut-czysta', 'absolut-vodka.jpg', 57.99, 'Wódka czysta Absolut', 1000, 40, 1);
...
insert into products (name, image, unit_price, description, size, concentration, category_id) values('Fresco', 'los-pinguinos.jpg', 22.99, 'Różowe pół słodkie', 750, 10, 2);
insert into products (name, image, unit_price, description, size, concentration, category_id) values('Fresco', 'el-sol.jpg', 32.99, 'Hiszpańskie różowe pół słodkie', 750, 12, 2);
